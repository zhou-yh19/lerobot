...
def decode_video_frames_torchcodec(
    ...
    # some muxers (e.g. ffmpeg 7.x) write the container duration without the
    # last frame's display time, inflating average_fps so the last requested
    # index rounds one past the end
